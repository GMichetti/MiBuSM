        ...
        try:
            info = {
                "hw_info": {
                    ...
                    "systemHealthInfo": [{"sensor_name": sensor.name, "status": sensor.healthState.key} for sensor in self._esxihost.runtime.healthSystemRuntime.systemHealthInfo.numericSensorInfo]
                },
                "vm_info": [
                    {
                        "name": vm.name,
